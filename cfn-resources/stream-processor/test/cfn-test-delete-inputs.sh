...
# Delete stream instance/workspace
...
# Delete cluster (if it exists - stored in inputs_3 for DLQ testing)
if [ -f "./inputs/inputs_3_create.json" ]; then
	clusterName=$(jq -r '.ClusterName // empty' ./inputs/inputs_3_create.json)
